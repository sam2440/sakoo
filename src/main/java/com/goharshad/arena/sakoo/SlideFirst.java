...
public class SlideFirst extends Fragment {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser && view != null) {
            scaleView(R.id.slide_1_circle, 0, 1, 500, 5);
            translateAlphaView(R.id.first_slide_powerlifter,200,500,500);
            ...
            descaleView(R.id.slide_1_circle);
            deTranslateAlphaView(R.id.first_slide_powerlifter,200);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getUserVisibleHint() && view != null) {
            ...
            translateAlphaView(R.id.first_launch_slide_title,10,500,0);
            translateAlphaView(R.id.first_launch_slide_txt, 10,500,0);
        } else if (!getUserVisibleHint() && view != null) {
            descaleView(R.id.slide_1_circle);
            deTranslateAlphaView(R.id.first_slide_powerlifter,200);
            deTranslateAlphaView(R.id.first_launch_slide_title,10);
            deTranslateAlphaView(R.id.first_launch_slide_txt,10);
